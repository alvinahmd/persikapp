      ...
      <div class="w-full max-w-screen-sm bg-white max-h-screen" style="z-index: 1;">
        <div>
          <div class="max-w-screen-sm mx-auto">
            ...
            <div class="container">
              <div class="flex py-2 px-5 rounded-t-xl bg-white mb-3">
                <div class="flex justify-center">
                  ...
                  <router-link to="/tiket2">
                    <img src="/pot.png" alt="" class=" rounded-lg w-32 h-32">
                  </router-link>
                </div>
                ...
                <div class="flex flex-row justify-between pt-28 px-2 absolute right-1/3">
              ...
              <div class="flex py-2 px-5 rounded-t-xl bg-white shadow-lg">
                <div class="flex justify-center">
                  <div class="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
                    <input
                      id="checkboxCheckedNoLabel"
                ...
                <div class="flex flex-row pt-20 ">
                  <div id="app" class="flex justify-center items-center">
                    ...
                    <div class="px-3 border border-3 rounded-full text-xl items-center text-purple-900 text-center border-purple-900 cursor-pointer">
                      <button class=" text-xl items-center text-slate-600 text-center" @click="changeCounter('+1')">
                        +
                      </button>
                    </div>
                ...
                <div class="flex flex-row justify-between pt-28 px-2 absolute right-1/3">
                  <h1 class="font-medium border-t text-gray-600">
                    tersisa 189 tiket
                  </h1>
                </div>
              </div>
