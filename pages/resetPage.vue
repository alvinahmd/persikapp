<template>
  <div>
    <div class="fixed top-0 left-0 flex justify-center items-end w-screen h-full">
      ...
      <div class="w-full max-w-screen-sm bg-white max-h-screen" style="z-index: 1;">
        ...
        <div class="container px-5 space-y-10 py-3">
          ...
          <button class="rounded-lg w-full text-white text-base font-bold py-3 bg-purple-900 hover:bg-purple-700 duration-500">
            Kirim
          </button>
        </div>
      </div>
